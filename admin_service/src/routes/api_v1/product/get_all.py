...
from src.usecases.admin.product.get_all import GetProducts
...
async def get_all(
    ...
    try:
        get_all_user_products_usecase = GetProducts(product_service)
        outputs_list = await get_all_user_products_usecase.execute(user.credentials, criteria)
