...
from src.infra.external_api.service.category_service import CategoryService
...
from src.infra.external_api.service.order_service import OrderService
...
def get_category_service() -> ICategoryService:
    ...
    return CategoryService(base_url)
...
def get_order_service() -> IOrderService:
    base_url = get_app_state(app, AppStates.ORDER_BASE_URL)
    return OrderService(base_url)
