...
class CategoryService(ICategoryService):
    ...
    def create(
        ...
        response = requests.post(target_url, headers=headers, params=category_data.model_dump(mode="json"))
    ...
    def update_one(
        ...
        response = requests.put(target_url, headers=headers, params=category_data.model_dump(mode="json"))
