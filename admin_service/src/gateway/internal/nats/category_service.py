...
class CategoryBrokerService(ICategoryService):
    ...
    async def create(
        ...
        response = await self.client.broker.request(
            message=category.model_dump(mode="json"),
            headers={
                "token": credentials.access_token,
            },
            subject="product_service.category.create",
            timeout=10,
        )
    ...
    async def update(
        ...
        response = await self.client.broker.request(
            ...
            subject="product_service.category.update",
            timeout=10,
        )
    ...
    async def delete_by_id(
        ...
        response = await self.client.broker.request(
            ...
            subject="product_service.category.delete.by-id",
            timeout=10,
        )
    ...
    async def delete_all(
        ...
        response = await self.client.broker.request(
            ...
            subject="product_service.category.delete.all",
            timeout=10,
        )
